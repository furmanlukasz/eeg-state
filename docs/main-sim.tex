...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/paper1/fig_analysis_main.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/paper1/fig_flow_fields.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/paper1/fig_discriminability.png}

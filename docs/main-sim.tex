...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/paper1/fig_electrode_demo.png}
...
Different metrics showed different sensitivity profiles: speed and variance strongly discriminated topologies, while tortuosity showed negligible discriminability for this particular contrast. This suggests that metric selection should be guided by the hypothesized nature of regime differences.
